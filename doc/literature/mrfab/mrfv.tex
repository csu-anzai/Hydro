...
\section{Harten's Multiresolution Scheme}
    ...
    \subsection*{Encoding}
        ...
        \begin{equation}
%            \tilde{u}_{i}^{l+1} = \left( \bm{P}_{l}^{l+1} \bm{u}^{l}
%            \right)_{i} = 
%            \begin{cases}
%                u_{i/2}^{l} - \sum_{p=1}^{s} \gamma_{p} \left( u^{l}_{i/2-p} -
%                u^{l}_{i/2+p} \right), \text{ } \text{ } \text{ } \forall
%                i \in \bm{\mathcal{I}}_{even}^{l+1} \\
%                u_{(i+1)/2}^{l} + \sum_{p=1}^{s} \gamma_{p} \left(
%                u^{l}_{(i+1)/2-p} - u^{l}_{(i+1)/2+p} \right), \text{ }
%                \text{ } \text{ } \forall i \in \bm{\mathcal{I}}_{odd}^{l+1}
%            \end{cases}

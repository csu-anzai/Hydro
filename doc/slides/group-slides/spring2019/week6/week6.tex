...
\begin{frame}{Preliminary Results}
  ...
  \begin{figure}
    \center
    \movie[width=0.4\textwidth,height=0.3\textwidth, poster]{}{detailcoeff_lores.avi}
  \end{figure}
\end{frame}
...
\begin{frame}{Preliminary Results}
  \begin{figure}
    \center
    \movie[width=0.4\textwidth,height=0.3\textwidth, poster]{}{detailcoeff_hires.avi}
  \end{figure}
\end{frame}
...
\begin{frame}{Preliminary Results}
  \begin{figure}
    \center
    \movie[width=0.4\textwidth,height=0.3\textwidth, poster]{}{density_lores.avi}
  \end{figure}
\end{frame}

...
LayerAverage::LayerAverage(void)
{
...
void LayerAverage::calcLayerAverage(FlashAmrMesh* mesh,int sweepDir, int nBins, int varIndex )

{
 
    int secondDir, thirdDir, sweepInd;
    ...
    switch(sweepDir)
    {
        ...
        default:
        {
            cout << "calcLayerAverage : invalid sweepDir, must be IAXIS, JAXIS, or KAXIS" << endl;
		    exit(EXIT_FAILURE);
        }
    }
    ...
    sweepDirMinFace = new double [mesh->getNcells(sweepDir)]; 
    sweepDirMaxFace = new double [mesh->getNcells(sweepDir)]; 
    secondDirCoords = new double [mesh->getNcells(secondDir)]; 
    thirdDirCoords  = new double [mesh->getNcells(thirdDir)]; 
	...
	delete blockList;
    delete sweepDirMinFace;
    delete sweepDirMaxFace;
    delete secondDirCoords;
    delete thirdDirCoords;

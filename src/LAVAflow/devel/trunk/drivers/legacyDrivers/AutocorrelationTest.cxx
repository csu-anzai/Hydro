#include "../libsrc/Turbulence/TimeAutoCorr.h"
...
int main(int argc, char** argv)
{
	...
	string baseFilename("./tburn_hdf5_plt_cnt_");
	int fileNumBounds[2] = {0, 20};
	...
	TimeAutoCorr autoCorr(baseFilename, fileNumBounds, numPoints);
